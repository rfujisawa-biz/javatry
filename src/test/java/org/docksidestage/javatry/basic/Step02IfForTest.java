...
public class Step02IfForTest extends PlainTestCase {
    ...
    public void test_if_elseif_nested() {
        ...
        // done fujisawa 個人的には、業務を初めて約一年経つけど、もはや漠然よみが一番助けになってることのひとつかも！ by shiny (2025/08/13)
        // 結局プログラマーはコードを読んでる時間が一番長いもんね、、新しい実装する時、リファクタする時、コードレビューする時、など全てでいかに構造を早く把握できるかがアウトプットの量と質に直結してるなと感じます！
        // done shiny まだ漠然読みより先に手が動いてlogを出力し出してしまうので、意識しないとですね by hal (2025/08/27)
        // done fujisawa ログを読むときも漠然読みだから笑 (業務のログだと巨大で欲しい情報を引き当てるの大変) by jflute (2025/09/08)
    }

...
public class Step03DataTypeTest extends PlainTestCase {
    ...
    public void test_datatype_primitive() {
        ...
        // done fujisawa [むずかしいね笑] これを読んでふと思ったこと（直接関係ないのだが）by shiny (2025/08/18)
        // 組織でプロダクトを開発する上で、特定の言語やフレームワーク・ライブラリを選定する時に、利便性 x 難しさ -> maintainability という思考がよぎる
        // ↑というキーワードだけてきとうに残すので、もしよかったら考えてみてください笑（雑）
    }
